...
GET|HEAD        api/v1/customers/{customer}/enquiries
POST            api/v1/customers/{customer}/enquiries
GET|HEAD        api/v1/customers/{customer}/enquiries/{enquiry}
PUT|PATCH       api/v1/customers/{customer}/enquiries/{enquiry}
DELETE          api/v1/customers/{customer}/enquiries/{enquiry}
...
GET|HEAD        api/v1/enquiries

GET|HEAD        api/v1/product-categories
POST            api/v1/product-categories
GET|HEAD        api/v1/product-categories/{product_category}
PUT|PATCH       api/v1/product-categories/{product_category}
